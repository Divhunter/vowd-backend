...
module.exports.sendMail = (req, res, next) => {
    ...
    if (!verifUser) {
        ...
        const mailOptions = {
            ...
            html: `<p>Bonjour ${userName}, voici le lien pour réinitialiser votre mot de passe <a href="https://vowd-project-app-api.onrender.com/updatePassword" >réinitialisation</a></p>`
        }
