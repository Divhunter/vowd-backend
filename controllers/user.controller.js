    ...
    .then(user => {
        if (user) {
            ...
            transporter.sendMail({
                ...
                html: `<p>Bonjour ${userName}, voici le lien pour réinitialiser votre mot de passe <a href = '${process.env.CLIENT_URL}/password + req.headers.host', user >réinitialisation</a></p>`
            });
